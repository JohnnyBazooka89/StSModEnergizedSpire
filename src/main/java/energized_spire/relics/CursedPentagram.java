...
public class CursedPentagram extends CustomRelic {
    ...
    public void onObtainCard(AbstractCard c) {
        ...
        if(this.counter == CARDS_TO_ADD){
            this.counter = 0;
            this.flash();
            AbstractDungeon.topLevelEffectsQueue.add(new ShowCardAndObtainEffect(AbstractDungeon.returnRandomCurse(), (float) (Settings.WIDTH / 2.0f), (float) (Settings.HEIGHT / 2.0f)));
        }
    }
