...
public class OldTV extends CustomRelic {
    ...
    public static final int FOCUS_TO_LOSE = 1;
    ...
    public void atBattleStart() {
        ...
        AbstractDungeon.actionManager.addToBottom(new ApplyPowerAction(AbstractDungeon.player, AbstractDungeon.player, new FocusPower(AbstractDungeon.player, -FOCUS_TO_LOSE), -FOCUS_TO_LOSE));
    }
    ...
    public String getUpdatedDescription() {
        return DESCRIPTIONS[0] + FOCUS_TO_LOSE + DESCRIPTIONS[1];
    }
}
